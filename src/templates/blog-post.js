          ...
          <footer>
            ...
            <div style={{
              ...
              <div class="icon comment-icon">
                <a href="https://twitter.com/LucasWonderley/status/1209964727222317056" target="_blank"><img src={twitter}/></a>
              </div>
              <div class="icon comment-icon">
                <a href="https://dev.to/wonderley/code-reviews-1n82" target="_blank" class="logo-link" id="logo-link" aria-label="DEV Home">
