          ...
          <footer>
            ...
            <div style={{
              ...
              <div class="icon comment-icon">
                <a href={post.frontmatter.twitterUrl || "https://twitter.com/LucasWonderley"} target="_blank"><img src={twitter}/></a>
              </div>
              <div class="icon comment-icon">
                <a href={post.frontmatter.devUrl || "https://dev.to/wonderley"} target="_blank" class="logo-link" id="logo-link" aria-label="DEV Home">
                  <svg xmlns="http://www.w3.org/2000/svg" version="1" width="44px" viewBox="0 0 132.000000 65.000000" role="img" aria-labelledby="ad3l25jy03hydixblpc0qajqc106jlvi" class="logo"><title id="ad3l25jy03hydixblpc0qajqc106jlvi">App logo</title>
